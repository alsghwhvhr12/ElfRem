...
public class LoveCountDDataBase {
    final String DB_MYLOVE = "mycount.db";
    ...
    public static LoveCountDDataBase getInstance(Context context, String table) {
        TABLE_LOVES = table;

        String Group;
        if (TABLE_LOVES.equals("MySong")) Group = "GroupID";
        else Group = "CustomerID";
        return new LoveCountDDataBase(context, Group);
    }

    private LoveCountDDataBase(Context context, String group) {
