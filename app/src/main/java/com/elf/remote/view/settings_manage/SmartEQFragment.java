...
import com.elf.remote.viewmodel.settings_manage.SmartEQViewModel;

import java.util.ArrayList;


public class SmartEQFragment extends Fragment implements CallActivity {
    public static FileAdapter myAdapter;
    public static SmartEQViewModel model;
    FragmentSmartEqBinding binding;

    public SmartEQFragment() {
    }

    public static SmartEQFragment getInstance() {
        return new SmartEQFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        model = new SmartEQViewModel(this);

        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_smart_eq, container, false);
