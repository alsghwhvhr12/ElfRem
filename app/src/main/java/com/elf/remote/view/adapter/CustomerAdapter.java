...
public class CustomerAdapter extends BaseAdapter {
    ...
    List<CustomerFile> mySonglist;
    ArrayList<CustomerFile> mySongs;
    ...
    public CustomerAdapter(Context context, List<com.elf.remote.model.data.CustomerFile> data) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        final CustomerFile mySong = mySonglist.get(position);
